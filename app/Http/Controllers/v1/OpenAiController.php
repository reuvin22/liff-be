...
class OpenAiController extends Controller
{
    public function generatedResult($answers, $userId)
    {
        ...
        $prompt10 = '志望する理由、志望する会社に魅力を感じた理由となるように、体験やそこで感じた気持ちや学んだこととミッションや理念ならびに事業に共通点があることを説明してください。';
        ...
        $prompt14 = '【】で囲まれた内容について、能力を発揮した様子が読み手に伝わる文章を創作してください。';
        $prompt15 = '（）で示した内容をもとに以下の条件と順序で文章を作成してください。①企業理念・事業内容・仕事内容を示す ②魅力を感じた理由を経験と関連付けて説明 ③整合性がない場合は理由のみ創作する';
        $prompt16 = '④：'. $answers->Question_1. ', '. $answers->Question_2. 'が活かせる職種を示し、志望動機として説明してください。';
        $prompt17 = '⑤：最後に企業理念の実現に貢献したいという思いを伝えてください。';
        $prompt18 = 'ガクチカと志望動機を前提に、自己PRを以下の流れで作成してください（強み→活用方法→成果→事業貢献→理念貢献→宣言→依頼）。';
