        ...
        try {
            ...
            $result = $client->chat()->create([
                ...
                'messages' => [
                    [
                        'role' => 'system',
                        'content' => "#以下の文章を日本語で読み手にわかりやすいよう書いてください。
                        ...
                        【大学時代に日本一周の活動を通じて、行動力、コミュニケーション能力を発揮したエピソードについて説明します。具体的には、Youtubeに投稿する動画を主演で撮りながら旅をするとして誰とでも話せるコミュニケーション能力を身に着ける、をめざして取り組んだ経験です。説明の中で、どのように行動力、コミュニケーション能力を発揮したかについて具体的に説明してください。具体的に説明するための条件として、行動力とは必要な行動を自発的に実行できるです。また、コミュニケーション能力とは相手の意図を理解し、相手の理解度に応じて話す内容や話し方を変えることにより、的確に情報を伝えることができるです。活動の目的は誰とでも話せるコミュニケーション能力を身に着けるであったが、課題であった老若男女問わず話す勇気がなかったの改善に取り組んだ。この取り組みで、行動力及びコミュニケーション能力を発揮し、恥ずかしくても元気よく話しかけることを意識した。結果として、投稿する動画は50万再生以上行き、誰と話すことも怖くなくなった。】

                        私が志望している企業のサイトは｛https://www.momotaro.co.jp/｝です。#まとめて後の文章に繋げてください。
                        （私は丸和運輸機関を志望しています。志望する理由、志望する会社に魅力を感じた理由となるように、体験や体験で感じた気持ちや学んだこととミッションや理念ならびに事業に共通点があることを説明する文章を創作して説明してください。丸和運輸機関のミッションや理念は“お客様第一義”を基本に、
                        サードパーティ・ロジスティクス業界のNo.1企業を目指し、
                        同志の幸福と豊かな社会づくりに貢献する。です。志望する会社で活かせる能力について行動力と、コミュニケーション能力があります。この能力、経験を活かして、貴社の**で貢献致します。#**の中は｛｝内のサイトから職種を選択してください）
                    ...
                    [
                        'role' => 'user',
                        'content' => (string) $prompt1, (string) $prompt2, (string) $prompt3, (string) $prompt4, (string) $prompt5, (string) $prompt6, (string) $prompt7, (string) $prompt8, (string) $prompt9, (string) $prompt10, (string) $prompt11, (string) $prompt12, (string) $prompt13, (string) $prompt14, (string) $prompt15, (string) $prompt16, (string) $prompt17, (string) $prompt18,
                    ]
                ]
            ]);

            Log::info('Answers: ', ['answers' => (string) $prompt1, (string) $prompt2, (string) $prompt3, (string) $prompt4, (string) $prompt5, (string) $prompt6, (string) $prompt7, (string) $prompt8, (string) $prompt9, (string) $prompt10, (string) $prompt11, (string) $prompt12, (string) $prompt13, (string) $prompt14, (string) $prompt15, (string) $prompt16, (string) $prompt17, (string) $prompt18]);
        ...
        try {
            ...
            $result = $client->chat()->create([
                ...
                'messages' => [
                    [
                        'role' => 'system',
                        'content' => "【ガクチカ】の内容について、以下の流れで端的な文章を作成してください。
